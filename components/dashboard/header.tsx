    ...
    <header className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-2">
      <div className="flex items-center gap-4">
        <div className="relative">
          {/* Logo com fundo escuro arredondado */}
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground flex items-center gap-1">
            ...
            Atualização automática a cada {updateInterval}s
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        {onForceCheck && (
          <button
            ...
            title="Forçar verificação manual"
          >
        ...
        >
          ...
          <span className="text-sm font-medium hidden sm:inline">
            {isAutoRotating ? "Rotação Ativa" : "Rotação Pausada"}
          </span>
        </button>
